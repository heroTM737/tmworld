...
export default class StrategyTab extends Component {
    render() {
        return (
            <div className="box-list">
                <div className="box">
                    <div className="box-header"><span className="box-title">Max soldier</span></div>
                ...
                <div className="box">
                    <div className="box-header"><span className="box-title">Max vehicle</span></div>
                    <div className="box-body">
                        <div>
                            <ul>
                                <li>defender: orca</li>
